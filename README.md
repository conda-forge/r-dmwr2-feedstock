...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-dmwr2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12963&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-dmwr2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-dmwr2` can be installed with:

```
conda install r-dmwr2
```

It is possible to list all of the versions of `r-dmwr2` available on your platform with:
